      ...
      >
        ...
        <article className="flex flex-col sm:basis-7/12 gap-3.5">
          ...
          <p className="text-2xl clump:text-[clamp(1.15rem,3vw,1.5rem)] text-philippine-gray leading-normal">
            At the core of our approach is a commitment to your success. We
            invest our knowledge, experience, and passion into delivering
            tailored strategies that align with your unique goals and
            aspirations. Whether you're aiming for market expansion, digital
            transformation, or process optimization, our team of experts is
