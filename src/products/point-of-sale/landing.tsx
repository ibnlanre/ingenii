    ...
    <div className="py-14 px-2 relative clump:px-[clamp(8px,5vw,5rem)] max-w-8xl mx-auto gap-16 flex flex-col">
      <section className="flex flex-col md:items-center flex-wrap gap-x-4 md:flex-row gap-y-8 clump:gap-x-[clamp(1rem,2vw,6rem)]">
        <div className="flex flex-col flex-1 gap-14">
          <article className="flex flex-col gap-10 text-davys-grey">
            <h3
              className={clsx(
            ...
            <p className="text-xl">
              Looking for new POS, a modern, integrated retail solution with
              tools to sell everywhere - all managed from one place.
            </p>
          </article>
