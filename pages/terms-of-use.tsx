      ...
      <div className="py-14 px-2 relative clump:px-[clamp(8px,5vw,5rem)] max-w-8xl mx-auto gap-16 flex flex-col">
        <Stack spacing={48}>
          <Stack>
            ...
            <p>Welcome to Ingenii!</p>
            <p>
              These terms and conditions outline the rules and regulations for
              the use of Ingenii's Website, located at{" "}
              <Text
                component="a"
            ...
            <p>
              ...
              conditions. Do not continue to use Ingenii if you do not agree to
            ...
            <p>
              ...
              "Client", "You" and "Your" refer to you, the person logged on to
              this website and compliant to the Company's terms and conditions.
              <span className="font-medium">"The Company"</span>,{" "}
              <span className="font-medium">"Ourselves"</span>,{" "}
              <span className="font-medium">"We"</span>,{" "}
              <span className="font-medium">"Our"</span> and{" "}
              <span className="font-medium">"Us"</span>, refers to our Company.{" "}
              <span className="font-medium">"Party"</span>,{" "}
              <span className="font-medium">"Parties"</span>, or{" "}
              <span className="font-medium">"Us"</span>, refers to both the
          ...
          <Stack>
            <Subtext>Cookies</Subtext>
            <p>
              We employ the use of cookies. By accessing Ingenii, you agree to
              use cookies in agreement with Ingenii's Privacy Policy, located at{" "}
              <Text
                component="a"
                href="https://www.ingeniihq.com/privacy-policy"
                color="#8F00FF"
              >
                https://www.ingeniihq.com/privacy-policy
              </Text>
            </p>
            ...
            <p>
              ...
              statistical or marketing purposes to operate our website. Cookies
              are used by our website to enable the functionality of certain
              areas to make it easier for people visiting our website. You have
          ...
          <Stack>
            <Subtext>License</Subtext>
            <p>
              Unless otherwise stated, Ingenii and/or its licensors own the
              intellectual property rights for all material on Ingenii. All
              intellectual property rights are reserved. You may access this
              from Ingenii for your own personal use subject to restrictions set
            ...
            <ul className="list-disc ml-9">
              <li>Republish material from Ingenii</li>
              <li>Sell, rent, or sub-license material from Ingenii</li>
              <li>Reproduce, duplicate, or copy material from Ingenii</li>
              <li>Redistribute content from Ingenii</li>
            </ul>
            ...
            <p>
              ...
              Ingenii does not filter, edit, publish, or review Comments prior
              to their presence on the website. Comments do not reflect the
              views and opinions of Ingenii, its agents, and/or affiliates.
              ...
              laws, Ingenii shall not be liable for the Comments or for any
            ...
            <p>
              Ingenii reserves the right to monitor all Comments and to remove
            ...
            <p>
              You hereby grant Ingenii a non-exclusive license to use,
          ...
          <Stack>
            <Subtext>Hyperlinking to our Content</Subtext>
            <p>
            ...
            <ul className="list-disc ml-9">
              ...
              <li>
                ystem-wide Accredited Businesses except soliciting non-profit
            ...
            <p>
              ...
              Ingenii; and (d) the link is in the context of general resource
              information.
            </p>
            ...
            <p>
              ...
              by sending an e-mail to contact@ingeniihq.com. Please include your
              name, your organization name, and contact information as well as
            ...
            <p>
              No use of Ingenii's logo or other artwork will be allowed for
              linking absent a trademark license agreement.
            </p>
          </Stack>

          <Stack>
            <Subtext>iFrames</Subtext>
            <p>
          ...
          <Stack>
            <Subtext>Content Liability</Subtext>
            <p>
          ...
          <Stack>
            <Subtext>Reservation of Rights</Subtext>
            <p>
          ...
          <Stack>
            <Subtext>Removal of links from our website</Subtext>
